<?php
//CONEXION MYSQL PARA EL GENERADOR DE EXCEL PERO ESTA SIN TERMINAR
		class Conexion{
			var $ruta;
			var $usuario;
			var $contrasena;
			...
			function Conexion(){
				...
				$this->baseDatos  ="laravel"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
